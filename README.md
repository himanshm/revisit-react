...
You can’t make the `useEffect` callback itself `async` (it expects a cleanup function or `void`), but you can define an async function inside it and call it. Example:
